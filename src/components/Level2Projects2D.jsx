          ...
          return (
            ...
            >
              <div>
                ...
                <div className="relative w-full h-52 bg-slate-900 overflow-hidden flex items-center justify-center group-hover:scale-102 transition-transform duration-300">
                  {project.posterUrl ? (
                    <img
                    ...
                    <div className={`w-full h-full bg-gradient-to-br ${project.color || 'from-purple-600 to-pink-500'} flex items-center justify-center text-4xl`}>
                      {project.emoji}
                    </div>
                  )}
                  ...
                  <div className="absolute inset-0 z-20 flex items-center justify-center">
                    <button
                      ...
                      className="w-16 h-16 bg-purple-600/90 hover:bg-purple-600 text-white rounded-full flex items-center justify-center shadow-2xl backdrop-blur-md group-hover:scale-115 transition-transform duration-300 border-4 border-white/80"
                    >
